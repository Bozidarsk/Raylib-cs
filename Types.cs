...
namespace Raylib 
{
	public struct Color 
	{
		...
		public static Color HexToColor(string hex) 
		{
			...
			byte r = (byte)Utils.Format.HexToDecimal(System.Convert.ToString(hex[0]) + System.Convert.ToString(hex[1]));
			byte g = (byte)Utils.Format.HexToDecimal(System.Convert.ToString(hex[2]) + System.Convert.ToString(hex[3]));
			byte b = (byte)Utils.Format.HexToDecimal(System.Convert.ToString(hex[4]) + System.Convert.ToString(hex[5]));
	...
	public unsafe struct Image 
	{
		...
		public static Image GenerateWithColor(int width, int height, Color color) { return GenImageColor(width, height, color); }
		...
		{
			this.data = GenerateWithColor(width, height, Color.Transparent).data;
			this.width = width;
			this.height = height;
			this.mipmaps = 1;
		...
		{
			this.data = GenerateWithColor(width, height, color).data;
			this.width = width;
			this.height = height;
			this.mipmaps = 1;
			this.format = PixelFormat.UncompressedR8G8B8A8;
